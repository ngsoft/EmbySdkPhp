...
class GameInfo extends \EmbyClient\Model
{
    protected static array $mapping = [
        'searchInfo' => \EmbyClient\Model\Providers\GameInfo::class,
    ];

    protected \EmbyClient\Model\Providers\GameInfo $searchInfo;
    ...
    public function getSearchInfo(): \EmbyClient\Model\Providers\GameInfo
    {
