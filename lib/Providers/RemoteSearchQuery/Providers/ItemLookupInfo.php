...
class ItemLookupInfo extends \EmbyClient\Model
{
    protected static array $mapping = [
        'searchInfo' => \EmbyClient\Model\Providers\ItemLookupInfo::class,
    ];

    protected \EmbyClient\Model\Providers\ItemLookupInfo $searchInfo;
    ...
    public function getSearchInfo(): \EmbyClient\Model\Providers\ItemLookupInfo
    {
