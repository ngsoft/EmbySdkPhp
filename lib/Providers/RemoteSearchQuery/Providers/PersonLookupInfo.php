...
class PersonLookupInfo extends \EmbyClient\Model
{
    protected static array $mapping = [
        'searchInfo' => \EmbyClient\Model\Providers\PersonLookupInfo::class,
    ];

    protected \EmbyClient\Model\Providers\PersonLookupInfo $searchInfo;
    ...
    public function getSearchInfo(): \EmbyClient\Model\Providers\PersonLookupInfo
    {
