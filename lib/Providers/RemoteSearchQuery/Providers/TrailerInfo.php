...
class TrailerInfo extends \EmbyClient\Model
{
    protected static array $mapping = [
        'searchInfo' => \EmbyClient\Model\Providers\TrailerInfo::class,
    ];

    protected \EmbyClient\Model\Providers\TrailerInfo $searchInfo;
    ...
    public function getSearchInfo(): \EmbyClient\Model\Providers\TrailerInfo
    {
